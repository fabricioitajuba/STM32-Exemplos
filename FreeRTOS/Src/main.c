...
/**
Exemplo de uso do FreeRTOS (multi-trheads)
Eng. Fabrício de Lima Ribeiro
01/03/2019

Descricao: Neste exemplo utilizando a placa blue-pill, piscarao 2 leds de forma independente

link:
https://www.youtube.com/watch?v=c-tNsfPSLdg
...
int main(void)
{
  ...
  //Configuracao da thread1
  osThreadDef(defaultTask, StartDefaultTask, osPriorityNormal, 0, 128);
  defaultTaskHandle = osThreadCreate(osThread(defaultTask), NULL);
  //Configuracao da thread2
