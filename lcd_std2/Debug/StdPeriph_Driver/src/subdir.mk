...
StdPeriph_Driver/src/%.o: ../StdPeriph_Driver/src/%.c
	...
	@echo $(PWD)
	arm-none-eabi-gcc -mcpu=cortex-m3 -mthumb -mfloat-abi=soft -DSTM32 -DSTM32F1 -DSTM32F103C8Tx -DDEBUG -DSTM32F10X_MD -DUSE_STDPERIPH_DRIVER -I"D:/Informações/Microcontroladores/ARM/Projetos/System workbench/lcd_std2/StdPeriph_Driver/inc" -I"D:/Informações/Microcontroladores/ARM/Projetos/System workbench/lcd_std2/inc" -I"D:/Informações/Microcontroladores/ARM/Projetos/System workbench/lcd_std2/CMSIS/device" -I"D:/Informações/Microcontroladores/ARM/Projetos/System workbench/lcd_std2/CMSIS/core" -O0 -g3 -Wall -fmessage-length=0 -ffunction-sections -c -MMD -MP -MF"$(@:%.o=%.d)" -MT"$@" -o "$@" "$<"
